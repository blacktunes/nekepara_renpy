...
define config.name = _("HIIROPARA")
...
define build.name = "Hiiropara"


## 鼠标
define config.mouse = { }
define config.mouse['default'] = [ ( "gui/mouse/cur_normal.cur", 15, 15) ]
define config.mouse['over'] = [ ( "gui/mouse/cur_over.cur", 15, 15) ]
...
define config.save_directory = "Hiiropara-1677138425"
