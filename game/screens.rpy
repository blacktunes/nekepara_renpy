...
style skip_frame:
    ypos gui.skip_ypos
    background Frame("gui/config/skip.png", gui.skip_frame_borders, tile=gui.frame_tile)
...
style notify_frame:
    ...
    background Frame("gui/config/notify.png", gui.notify_frame_borders, tile=gui.frame_tile)
...
style nvl_window:
    ...
    background "gui/message/nvl.png"
